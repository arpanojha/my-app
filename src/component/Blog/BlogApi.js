...
const BlogApi = [
	{
		...
		desc_one:
			"Quantum Student journal club meeting. We paved a road map for the semester. We plan to design and develop quantum hardware gates using low cost MZI using optics.",
		url: "",
	},
	{
		id: 2,
		...
		url: "https://careers.college.indiana.edu/blog/2022/02/28/announcing-the-2022-connect-challenge-winners/",
	},
	{
		id: 3,
		image: blog2,
		...
		desc_one:
			'Problem1(minimum_loss.py) : in a time series array find the minimum possible "loss" that can be incurred. Problem at : https://www.hackerrank.com/challenges/minimum-loss/problem . My solution in N log n time.',
		title_two: "The solution.",
		desc_two:
			"Use quicksort type implementation. As we move through the array we pick first element as pivot and move the future elements in order into left and right arrays and make recursive calls to these sub arrays.",
		title_three: "",
		desc_three:
			"Here we just check differences between pivot element and left array as we need the loss. Advantage: no fancy library needed just knowledge of data structures. Code available at : https://github.com/arpanojha/My_algorithms/tree/master/hacker%20rank​",
		url: "https://github.com/arpanojha/My_algorithms/tree/master/hacker%20rank",
	},
	{
		id: 4,
		image: blog3,
		...
		desc_one:
			"A Wipro cares initiative to paint an underprivileged classroom to make it more interactive and fun for the students . Wipro partnered with Art sparks Foundation to paint the murals . As volunteers we were required to assist in the designing and decorating.",
		title_two: "",
		desc_two:
	...
	},
	{
		...
		desc_one:
			"NITI AYOG just reached out to us through the Electronics Club website . They wanted some help regarding the setting up of Atal Tinkering Labs in the schools over North east . This is a co funded project from INTEL and Govt. of India details of which is beside the point.",
		title_two: "Our Role",
		desc_two:
